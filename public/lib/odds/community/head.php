 <body>
	<div id="wrapper">
		<div class="topmenu_w">
			<div class="topmenu">
				<div class="logo">
					<h1><a href="/odds/main.php"><img src="/odds/image/base/logo.jpg" alt="DDS CONNECT" /></a></h1>
				</div>
				<div class="gnb_w">
					<div class="gnb">
						<div class="gnbMenu">
							<ul>
								<li class=""><a href="/odds/game/main/game_main.php">ODDS</a><span></span></li>
								<li><a href="/odds/livescore/livescore_soccer.php">라이브 스코어</a><span></span></li>
								...
								<li class="on"><a href="/odds/community/community.php">커뮤니티</a><span></span></li>
							</ul>
						</div>
						<div class="login">
		...
		<div class="container_w">
			<div id="leftMenu">
				...
				<div class="banner"><a href=""><img src="/odds/image/main/banner02.jpg" alt="" /></a></div>
			</div><!-- leftMenu -->
