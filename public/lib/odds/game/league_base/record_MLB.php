		...
		for(var i=1;i<5;i++){		
			(function (k){
				$(".r_tit > li.ls01_tab_" + k ).click(function(){ 
					...
					$(this).parent().parent().siblings("div.ls01_"+k).addClass("active");
					return false;
				});
			}(i));
		};
				...
				<div class="livescore game">
					...
					<div class="game_w">
						<ul class="tab01 gameMain">
							...
							<li class="on"><a href="record_MLB.php">선수 기록</a></li>
							<li class=""><a href="score_MLB.php">상대 전적</a></li>
						</ul>
						<ul class="tab_view01 gameMain_view record_MLB">
							<li class="s5 active">
								<div class="relative">
									<div class="select " style="left:140px;top:-65px;right:auto;">
										<p class="off"><span class="pp" style="padding:0 10px">2016 시즌</span><span class="pa"></span></p>
										<ul>
									...
									<div class="r_tit_w">
										...
										<ul class="g_check_tab r_tit" style="">
											<li class="ls01_tab_1"><span></span><a href="">투수</a></li>
											<li class="on ls01_tab_2"><span></span><a href="">타자</a></li>
										</ul>
									</div>
									<div class="PL_REC ls01_1">
										<ul class="player_rec">
											<li>
												...
												<ul>
													<li><b>1. 블랙몬</b><b class="red">3.49</b><br /><span class="">콜로라도</span></li>
													<li><b>2. 블랙몬</b><b class="red">3.49</b><br /><span class="">콜로라도</span></li>
													<li><b>3. 블랙몬</b><b class="red">3.49</b><br /><span class="">콜로라도</span></li>
												</ul>
											</li>
											<li>
												<h3>승 리</h3>
										...
										<div class="gray_warp_w">
											<div class="gray_warp">
												...
												<div class="select ">
													<p class="off"><span class="pp" style="padding:0 10px">MLB 정규시즌</span><span class="pa"></span></p>
													<ul>
														<li><a href="">MLB 정규시즌</a></li>
														<li><a href="">MLB 시범시즌</a></li>
													</ul>
												</div>
												<div class="select">
