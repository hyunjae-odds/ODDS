...
<html xmlns="http://www.w3.org/1999/xhtml">
 <head>
  ...
  <title> ODDS CONNECT </title>
	...
	<script type="text/javascript" src="../../js/charts/loader.js"></script><!-- 팀정보 원형그래프 -->
...
/* ------------------------------------common------------------------------------- */
		...
		/*	//재야의분석/블로그보기 팝업탭
			for(var i=1;i<3;i++){		
				(function (k){
					$(".r_pop>ul.list> li.RP0" + k ).click(function(){ 
						$(this).siblings().removeClass("on");
						$(this).addClass("on");
						$(this).parent().siblings("ul.view").find("li").css("display","none");
						$(this).parent().siblings("ul.view").find("li").eq(k-1).css("display","block");
						return false;
					});
				}(i));
			};*/
