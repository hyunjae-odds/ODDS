								...
								<div class="loginBox">
									<div class="logbox01" style="display:block;"><!-- 기본 로그인 -->
										...
										<div class="log_b">
											...
											<ul class="input_textbox">
												<li><input class="" onfocus="this.value=''; return true" value="아이디" type="text" /></li>
												<li><input class="pw2" onfocus="this.value=''; return true" value="비밀번호" type="text" /></li>
											</ul>
									...
									<div class="logbox02"><!-- 아이디/비번찾기 -->
										...
										<div class="log_b">
											...
											<div class="relative">
												<ul class="tab01">
													<li class="log01 on"><a href="">아이디 찾기</a></li>
											...
											<ul class="input_textbox">
												...
												<li><input class="pw2" onfocus="this.value=''; return true" value="회원가입시 등록했던 이메일 주소" type="text" /></li>
											</ul>
									...
									<div class="logbox03"><!-- 회원가입 -->
										...
										<div class="log_b">
											<div class="border_bottom">
												...
												<p class="cho_p">이용약관, 개인정보 수집 및 이용, 위치정보 이용약관(선택), 프로모션 안내 메일 수신(선택)에 <span class="red">모두 동의</span>합니다.</p>
												<div class="clear"></div>
											</div>
											<div>
												<span class="check"></span>
												<p class="cho_p">이용약관 동의<span class="red small">(필수)</span></p>
												<div class="clear"></div>
												<div class="infobox">
													<br />
													<b>제 1 조 (목적)</b><br />
											...
											<div>
												<span class="check"></span>
												<p class="cho_p">개인정보 수집 및 이용에 대한 안내<span class="red small">(필수)</span></p>
												<div class="clear"></div>
												<div class="infobox">
													<br />
													<b>제 1 조 (목적)</b><br />
											...
											<div class="border_bottom">
												<span class="check"></span>
												<p class="cho_p">이벤트 등 프로모션 알림 메일 수신<span class="red small">(선택)</span></p>
												<div class="clear"></div>
											</div>
											<div>
												<div class="bg_gray" style="padding-bottom:0;">
													<ul class="input_textbox">
														<li><input class="" onfocus="this.value=''; return true" value="아이디" type="text" /><a href="" class="btn">중복 확인</a></li>
														<li><input class="pw1" onfocus="this.value=''; return true" value="비밀번호" type="password" /></li>
														<li><input class="pw2" onfocus="this.value=''; return true" value="비밀번호 재확인" type="password" /></li>
													</ul>
													<div class="clear"></div>
												</div>
												<div class="bg_gray">
													<ul class="input_textbox input_textbox2">
														<li><input class="" onfocus="this.value=''; return true" value="이름" type="text" style="width:367px;"/>
															<p><span class="on">남자</span><span>여자</span></p>
														</li>
														<li><label for="birth">생일</label><input class="border_right center" onfocus="this.value=''; return true" value="년(4자)" type="text" id="birth" style="width:105px;" />
															...
															<input class="center" onfocus="this.value=''; return true" value="일" type="text"  style="width:85px;" /><input class="" onfocus="this.value=''; return true" value="본인확인 이메일(선택)" type="text"  style="width:380px;" />
														</li>
														<li>
															<div class="relative border_right">
																<div class="select select02">
															...
															<input class="infor" onfocus="this.value=''; return true" value="휴대전화번호" type="text" style="width:155px;"/><a href="" class="btn" style="float:left;margin-top:10px;">인증번호 받기</a><input class="infor" onfocus="this.value=''; return true" value="인증번호" type="text"  style="width:303px;"/><a href="" class="btn" style="float:left;margin-top:10px;">확인</a>
														</li>
													</ul>
													<div class="clear"></div>
												</div>
					...
					<ul>
						...
						<li class="best baseball"><a href="" >야구</a>
							<ul class="bestleague" style="display:none;">
								<li class="best2"><a href=""><span class="scheduleL"></span>Today’s Matches</a>
									<ul class="bestleague2 " style="display:none;">
										<li><a href="/baseball/league/KBO"><span class="KBO_L"></span>KBO 리그</a></li>
										<li><a href="/baseball/league/MLB_A"><span class="majorL"></span>메이져리그</a></li>
									</ul>
								</li>
								<li class="best2"><a href=""><span class="popularityL"></span>인기 리그</a>
									<ul class="bestleague2 " style="display:none;">
										<li><a href="/baseball/league/KBO"><span class="KBO_L"></span>KBO 리그<span class="grayNm">6</span></a></li>
