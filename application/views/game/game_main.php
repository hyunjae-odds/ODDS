<link href="/public/lib/css/soccer.css" rel="stylesheet" type="text/css"/>
...
<div class="livescore game">
    <div class="topTitle">
        ...
        <a href=""><img src="/public/lib/image/batting/visual_main.jpg" alt="2017 SPONAVI BETTING EVENT! 누구나 1억원의 주인공이 될 수 있습니다. 이벤트 기간 : 2017년 5월 1일 ~ 2017년 12월 10일까지"></a>
    </div>
        ...
        <ul class="tab_view01 r_view pb50">
            <li class="active" id="s1">
                <table class="table_default game_main_table">
                    ...
                    <tr>
                        <th colspan="2" class="left pl20"><span class="country_173"></span>&nbsp;&nbsp;대한민국 // <a href="/public/lib/game/league_soccer/league.php">K-리그</a></th>
                        <th>승</th>
                        <th>무</th>
                        <th>패</th>
                        <th>B's</th>
                    ...
                    <tr>
                        ...
                        <td class="left pl20"><a href="/public/lib/game/main/dividend.php">아틸레티코 마드리드  vs  맨체스터 유나이티드</a></td>
                        <td>3.15</td>
                        <td>3.15</td>
                        <td>3.15</td>
                        <td rowspan="2">49</td>
                        <td rowspan="2" class="data">
                            <div class="data">
                                <span class="b_BTN3"><a href="/public/lib/game/league_soccer/match.php"></a></span><span class="r_BTN r_BTN2"><a href="">전문가 의견</a></span>
                            </div>
                            <!-- 재야의분석/블로그보기-->
            ...
            <li id="s2">
                <table class="table_default game_main_table">
                    ...
                    <tr>
                        <th colspan="2" class="left pl20"><span class="country_173"></span>&nbsp;&nbsp;대한민국 // <a href="/public/lib/game/league_base/league.php">KBO</a></th>
                        <th>승</th>
                        <th>무</th>
                        <th>패</th>
                        <th>B's</th>
                    ...
                    <tr>
                        <td rowspan="2">2017.08.01<br />22.30</td>
                        <td class="left pl20"><a href="/public/lib/game/main/dividend.php">LG vs 삼성</a></td>
                        <td>3.15</td>
                        <td>3.15</td>
                        <td>3.15</td>
                        <td rowspan="2">49</td>
