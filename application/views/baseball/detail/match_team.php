...
<div class="Match_w">
    <div class="match KBO">
        ...
        <div class="score_bar">
            <div>
                ...
                <div class="team_logo"><span class="<?=$team_initial[$schedule->away];?>_L"></span></div>
                <p>VS</p>
                <div class="team_logo"><span class="<?=$team_initial[$schedule->home];?>_L"></span></div>
                <div class="team">
    ...
    <div class="matchTab">
        <ul class="title">
            <li class="on"><a href="/baseball/match_team/KBO/<?=$schedule->no;?>/0">팀간 비교</a></li>
            <li><a href="/baseball/match_pitcher/KBO/<?=$schedule->no;?>/0">선발 비교</a></li>
        </ul>
        <ul class="result">
            <li id="r1" class="on">
                <div class="opinion">
                    <div class="graph">
                        ...
                        <div class="result_btn_div">
                            ...
                            <div class="left_g">
                                <?php foreach($schedule->away_recent as $key=>$item): ?><a class="result_btn" href="javascript:javascript:location.replace('/baseball/match_team/KBO/<?=$schedule->away_recent_ten_game[9-$key]['no'];?>/0');" onfocus="this.blur();"><img src="/public/lib/image/base/btn_<?=$item;?>.png" alt="" title="<?=$schedule->away_recent_ten_game[9-$key]['away'];?> <?=$schedule->away_recent_ten_game[9-$key]['score'];?> <?=$schedule->away_recent_ten_game[9-$key]['home'];?>"></a><?php endforeach; ?>
                            </div>
                            <p>최근 10경기</p>
                            <div class="right_g">
                                <?php foreach($schedule->home_recent as $key=>$item): ?><a class="result_btn" href="javascript:javascript:location.replace('/baseball/match_team/KBO/<?=$schedule->away_recent_ten_game[9-$key]['no'];?>/0');" onfocus="this.blur();"><img src="/public/lib/image/base/btn_<?=$item;?>.png" alt="" title="<?=$schedule->home_recent_ten_game[9-$key]['away'];?> <?=$schedule->home_recent_ten_game[9-$key]['score'];?> <?=$schedule->home_recent_ten_game[9-$key]['home'];?>"></a><?php endforeach; ?>
                            </div>
                ...
                <div class="match_w">
                    <div class="relative">
                        ...
                        <div class="select" style="width:108px;">
                            ...
                            <ul>
                                <li><a href="javascript:location.replace('/baseball/match_team/KBO/<?=$schedule->no;?>/'+document.body.scrollTop+'?h2h_selector=win_lose&home_selector=<?=$home_selector;?>&away_selector=<?=$away_selector;?>')">승패</a></li>
                                <li><a href="javascript:location.replace('/baseball/match_team/KBO/<?=$schedule->no;?>/'+document.body.scrollTop+'?h2h_selector=over_under&home_selector=<?=$home_selector;?>&away_selector=<?=$away_selector;?>')">O/U</a></li>
                            </ul>
                        </div>
                            ...
                            <?php if($h2h_selector=='win_lose'): ?>
                                ...
                                <?php foreach($h2h_last_six_game as $item): ?>
                                    <tr>
                                        ...
                                        <td>3.15</td>
                                        <td>51</td>
                                        <td><span class="b_BTN5" style="margin-top: 9px;"><a href="/baseball/match_team/KBO/<?=$item->no;?>/0">매치정보</a></span></td>
                                    </tr>
                                <?php endforeach; ?>
                            </table>
                            <?php else: ?>
                                ...
                                <?php foreach($h2h_last_six_game as $item): ?>
                                    <tr>
                                        ...
                                        <td>3.15</td>
                                        <td>51</td>
                                        <td><span class="b_BTN5"><a href="javascript:location.replace('/baseball/match_team/KBO/<?=$item->no;?>/'+document.body.scrollTop+'?h2h_selector=<?=$h2h_selector;?>&home_selector=<?=$home_selector;?>&away_selector=<?=$away_selector;?>&home_duration=<?=$home_duration;?>&away_duration=<?=$away_duration;?>')">매치정보</a></span></td>
                                    </tr>
                                <?php endforeach; ?>
                                </table>
                            <?php endif; ?>
                    ...
                    <div class="relative">
                        ...
                        <div class="select" style="right:115px;">
                            ...
                            <ul>
                                <li><a href="javascript:location.replace('/baseball/match_team/KBO/<?=$schedule->no;?>/'+document.body.scrollTop+'?h2h_selector=<?=$h2h_selector;?>&home_selector=win_lose&away_selector=<?=$away_selector;?>&home_duration=<?=$home_duration;?>&away_duration=<?=$away_duration;?>')">승패</a></li>
                                <li><a href="javascript:location.replace('/baseball/match_team/KBO/<?=$schedule->no;?>/'+document.body.scrollTop+'?h2h_selector=<?=$h2h_selector;?>&home_selector=over_under&away_selector=<?=$away_selector;?>&home_duration=<?=$home_duration;?>&away_duration=<?=$away_duration;?>')">O/U</a></li>
                            </ul>
                        </div>
                        <div class="select" style="width:108px;">
                            <p class="off"><span class="pp"><?=$home_duration;?>경기</span><span class="pa"></span></p>
                            <ul>
                                <li><a href="javascript:location.replace('/baseball/match_team/KBO/<?=$schedule->no;?>/'+document.body.scrollTop+'?h2h_selector=<?=$h2h_selector;?>&home_selector=<?=$home_selector;?>&away_selector=<?=$away_selector;?>&home_duration=5&away_duration=<?=$away_duration;?>')">5경기</a></li>
                                <li><a href="javascript:location.replace('/baseball/match_team/KBO/<?=$schedule->no;?>/'+document.body.scrollTop+'?h2h_selector=<?=$h2h_selector;?>&home_selector=<?=$home_selector;?>&away_selector=<?=$away_selector;?>&home_duration=10&away_duration=<?=$away_duration;?>')">10경기</a></li>
                                <li><a href="javascript:location.replace('/baseball/match_team/KBO/<?=$schedule->no;?>/'+document.body.scrollTop+'?h2h_selector=<?=$h2h_selector;?>&home_selector=<?=$home_selector;?>&away_selector=<?=$away_selector;?>&home_duration=20&away_duration=<?=$away_duration;?>')">20경기</a></li>
                            </ul>
                        </div>
                    ...
                    <div class="relative">
                        ...
                        <div class="select" style="right:115px;">
                            ...
                            <ul>
                                <li><a href="javascript:location.replace('/baseball/match_team/KBO/<?=$schedule->no;?>/'+document.body.scrollTop+'?h2h_selector=<?=$h2h_selector;?>&home_selector=<?=$home_selector;?>&away_selector=win_lose&home_duration=<?=$home_duration;?>&away_duration=<?=$away_duration;?>')">승패</a></li>
                                <li><a href="javascript:location.replace('/baseball/match_team/KBO/<?=$schedule->no;?>/'+document.body.scrollTop+'?h2h_selector=<?=$h2h_selector;?>&home_selector=<?=$home_selector;?>&away_selector=over_under&home_duration=<?=$home_duration;?>&away_duration=<?=$away_duration;?>')">O/U</a></li>
                            </ul>
                        </div>
                        <div class="select" style="width:108px;">
                            <p class="off"><span class="pp"><?=$away_duration;?>경기</span><span class="pa"></span></p>
                            <ul>
                                <li><a href="javascript:location.replace('/baseball/match_team/KBO/<?=$schedule->no;?>/'+document.body.scrollTop+'?h2h_selector=<?=$h2h_selector;?>&home_selector=<?=$home_selector;?>&away_selector=<?=$away_selector;?>&away_duration=5&home_duration=<?=$home_duration;?>')">5경기</a></li>
                                <li><a href="javascript:location.replace('/baseball/match_team/KBO/<?=$schedule->no;?>/'+document.body.scrollTop+'?h2h_selector=<?=$h2h_selector;?>&home_selector=<?=$home_selector;?>&away_selector=<?=$away_selector;?>&away_duration=10&home_duration=<?=$home_duration;?>')">10경기</a></li>
                                <li><a href="javascript:location.replace('/baseball/match_team/KBO/<?=$schedule->no;?>/'+document.body.scrollTop+'?h2h_selector=<?=$h2h_selector;?>&home_selector=<?=$home_selector;?>&away_selector=<?=$away_selector;?>&away_duration=20&home_duration=<?=$home_duration;?>')">20경기</a></li>
                            </ul>
                        </div>
...
<script type="text/javascript">
    ...
    function add(no, flag){
        $.ajax({
            ...
            complete:function(){
                location.replace('/baseball/match_team/KBO/<?=$schedule->no;?>/'+document.body.scrollTop);
            }
        });
    }
