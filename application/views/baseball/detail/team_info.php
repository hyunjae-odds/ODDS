...
<div class="livescore game">
    ...
    <div class="game_w">
        <ul class="tab01 gameMain">
            <li class="on"><a href="/baseball/team_info/<?=$league;?>?team=<?=$team;?>">시즌 기록</a></li>
            ...
            <li class="active">
                ...
                <div class="pb50 relative">
                    ...
                    <div class="tab2_w absolute" style="top:10px;">
                        <ul class="tab02 LS_tab">
                            <li class="<?php if($home_away=='all') echo 'on';?> ls_all"><a href="/baseball/team_info/<?=$league;?>?team=<?=$team;?>">전체</a></li>
                            <li class="<?php if($home_away=='home') echo 'on';?> ls_home"><a href="/baseball/team_info/<?=$league;?>?team=<?=$team;?>&home_away=home">홈</a></li>
                            <li class="<?php if($home_away=='away') echo 'on';?> ls_team"><a href="/baseball/team_info/<?=$league;?>?team=<?=$team;?>&home_away=away">원정</a></li>
                        </ul>
                    </div>
                    <table class="table_default table_2_left">
                        ...
                        <?php foreach($rank_board as $item): ?>
                            ...
                            <tr>
                                <td><?=$item->rank;?></td>
                                <td><?=($league=='KBO')?$full_name_team[$item->team] : $MLB_team_kor[$item->team];?></td>
                                <td><?=$item->g;?></td>
                                <td><?=$item->win;?></td>
                                <td><?=$item->lose;?></td>
                                <td><?=$item->tie;?></td>
                ...
                <div class="pb50">
                    ...
                    <table class="table_default record_table01">
                        ...
                        <tr>
                            <td><?=($league=='KBO')? '득점권타율' :'OPS';?></td>
                            <td><span class="graph"><?=($league=='KBO')? $team_detail_record['offense_data']->risp : $team_detail_record['offense_data']->ops;?></span><p class="graph"><span style="width:<?=($league=='KBO')? 11-$team_detail_record['offense']['risp'].'0' : $get_rank_per[$team_detail_record['offense']['ops']];?>%"></span></p></td>
                            <td><?=($league=='KBO')? $team_detail_record['offense']['risp'] : $team_detail_record['offense']['ops'];?>위</td>
                        </tr>
                        <tr>
                            <td>볼넷</td>
                    ...
                    <table class="table_default record_table01">
                        ...
                        <tr>
                            <td><?=($league=='KBO')? 'QS' :'이닝';?></td>
                            <td><span class="graph"><?=($league=='KBO')? $team_detail_record['defence_data']->qs : $team_detail_record['defence_data']->ip;?>회</span><p class="graph"><span style="width:<?=($league=='KBO')? 11-$team_detail_record['defence']['qs'].'0' : $get_rank_per[$team_detail_record['defence']['ip']];?>%"></span></p></td>
                            <td><?=($league=='KBO')? $team_detail_record['defence']['qs'] : $team_detail_record['defence']['ip'];?>위</td>
                        </tr>
                        <tr>
                            <td>볼넷</td>
