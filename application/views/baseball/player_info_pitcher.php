				...
				<div class="livescore game">
					...
					<div class="game_w">
						<ul class="tab01 gameMain">
							<li class=""><a href="team_detail/team_info.php">시즌 기록</a></li>
							<li class=""><a href="team_detail/schedule.php">경기 결과</a></li>
							<li class="on"><a href="team_detail/player.php">선수 기록</a></li>
							<li class=""><a href="team_detail/situation.php">선수 현황</a></li>
							<li class=""><a href="team_detail/team.php">팀 소개</a></li>
						</ul>
