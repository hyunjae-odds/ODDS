    ...
    <div class="match KBO">
        ...
        <div class="score_bar">
            <div>
                ...
                <div class="num"><?=($data->away_score=='')? '0' : $data->away_score;?></div>
                <p>VS</p>
                <div class="num"><?=($data->home_score=='')? '0' : $data->home_score;?></div>
            ...
            <li id="r1" class="on"><!-- 팀간 비교 -->
                    ...
                    <div class="KBO_lineup_t">
                        <div class="left">
                            <div class="lineup_bar">
                                <?php if(isset($players['away_pitcher']['players']['starter'])): ?>
                                    <div>
                                        <h4><?=$players['away_pitcher']['players']['starter']; ?></h4>
                                        <span>No. <?=$players['away_pitcher']['starter_back_num']; ?></span>
                                        <b class="red">vs <?=$data->home;?></b>
                                    </div>
                            ...
                            <div class="line_pop">
                                ...
                                <div>
                                    ...
                                    <table class="table_default">
                                        ...
                                        <?php if(isset($players['away_pitcher']['players'])): foreach($players['away_pitcher']['players'] as $player): ?>
                                            <tr>
                                        ...
                                        <?php endforeach; else: ?>
                                            <tr>
                                                <td colspan="11"><span>당일 라인업이 아직 업데이트 되지 않았습니다.</span></td>
                                            </tr>
                                        <?php endif; ?>
                                    </table>
                                    <h4>타자 라인업</h4>
                                    <table class="table_default">
                                        ...
                                        <?php if(count($players['away_batter'])!=0): foreach($players['away_batter'] as $player): if($player->subi!=''): ?>
                                            <tr>
                                                <td><span class="up_arr01"></span></td>
                                                <td><?=$player->position;?></td>
                                                <td><span><?=$player->name;?></span></td>
                                                <td><?=$position_full_name[$player->subi];?></td>
                                                <td>3</td>
                                                <td>3</td>
                                                <td>3</td>
                                                <td>3</td>
                                        ...
                                        <?php endif; endforeach; else: ?>
                                            <tr>
                                                <td colspan="14"><span>당일 라인업이 아직 업데이트 되지 않았습니다.</span></td>
                                            </tr>
                                        <?php endif; ?>
                                    </table>
                                </div>
                            ...
                            <div class="pic_line"><img src="http://www.koreabaseball.com/file/person/middle/<?php if(isset($players['away_pitcher']['starter_id'])): echo $players['away_pitcher']['starter_id']; endif; ?>.jpg" alt="<?php if(isset($players['away_pitcher']['starter_id'])): echo $players['away_pitcher']['starter_id']; endif; ?>" onerror="this.src='http://www.koreabaseball.com/file/person/middle/noimg.jpg';"/></div>
                            <table class="table_default">
                                <caption></caption>
                                <colgroup>
                                </colgroup>
                                ...
                                <?php else: ?>
                                    <tr><td colspan="9" rowspan="3">당일 라인업이 아직 업데이트 되지 않았습니다.</td></tr>
                                <?php endif; ?>
                            </table>
                        </div>
                        <div class="right">
                            <div class="lineup_bar">
                                <?php if(isset($players['home_pitcher']['players']['starter'])): ?>
                                    <div>
                                        <h4><?php if(isset($players['home_pitcher']['players']['starter'])): echo $players['home_pitcher']['players']['starter']; endif; ?></h4>
                                        <span>No. <?php if(isset($players['home_pitcher']['starter_back_num'])): echo $players['home_pitcher']['starter_back_num']; endif; ?></span>
                                        <b class="red">vs <?=$data->away;?></b>
                                    </div>
                                    <p><b>3</b>승 <b>1</b>패 평균자책 <b>1.81</b></p>
                                <?php endif; ?>
                                <p class="line_btn"><a href="">전체 라인업보기<span></span></a></p>
                            ...
                            <div class="line_pop">
                                ...
                                <div>
                                    ...
                                    <table class="table_default">
                                        ...
                                        <?php if(isset($players['home_pitcher']['players'])): foreach($players['home_pitcher']['players'] as $player): ?>
                                            <tr>
                                                <td><span><?=$player;?></span></td>
                                                <td>4.1</td>
                                                <td>88</td>
                                    ...
                                    <table class="table_default">
                                        ...
                                        <?php if(count($players['home_batter'])!=0): foreach($players['home_batter'] as $player): if($player->subi!=''): ?>
                                            <tr>
                                                <td><span class="up_arr01"></span></td>
                                                <td><?=$player->position;?></td>
                                                <td><span><?=$player->name;?></span></td>
                            ...
                            <div class="pic_line"><img src="http://www.koreabaseball.com/file/person/middle/<?php if(isset($players['home_pitcher']['starter_id'])): echo $players['home_pitcher']['starter_id']; endif; ?>.jpg" alt="<?php if(isset($players['home_pitcher']['starter_id'])): echo $players['home_pitcher']['starter_id']; endif;?>" onerror="this.src='http://www.koreabaseball.com/file/person/middle/noimg.jpg';"/></div>
                            <table class="table_default">
                                <caption></caption>
                                <colgroup>
                                </colgroup>
                ...
                <div class="opponent">
                    ...
                    <ul class="opp02">
                        ...
                        <li>
                            <?php foreach($relative_match_result['home_win_lose_str'] as $key=>$item): ?>
                                <a href="/baseball/match_information/<?=$relative_match_result['away_game_no'][$key];?>/0" class="result_btn"><img src="/public/lib/image/base/btn_<?=$item;?>.png" alt="" title=""/></a>
                            <?php endforeach;?>
                        </li>
                    </ul>
                    ...
                    <table class="table_default">
                        ...
                        <?php foreach($away_result as $item): ?>
                            <tr>
                                ...
                                <td><?=$item['date'];?></td>
                                <td class="left pl20"><span <?php if($item['away']==$data->away) echo 'class="red"';?>><?=$full_name_team[$item['away']];?></span> vs <span <?php if($item['home']==$data->away) echo 'class="red"';?>><?=$full_name_team[$item['home']];?></td>
                    ...
                    <table class="table_default">
                        ...
                        <?php foreach($home_result as $item): ?>
                            <tr>
                                ...
                                <td><?=$item['date'];?></td>
                                <td class="left pl20"><span <?php if($item['away']==$data->home) echo 'class="red"';?>><?=$full_name_team[$item['away']];?></span> vs <span <?php if($item['home']==$data->home) echo 'class="red"';?>><?=$full_name_team[$item['home']];?></td>
                                <td class="score"><?=$item['score'];?></td>
                                <td><span class="black">1.24</span></td>
                                <td>2.13</td>
                                <td class="right gray">8.5</td>
